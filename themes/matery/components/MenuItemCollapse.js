  ...
  return (
    <>
      <div
        onClick={toggleShow}
        className={
          'py-2 px-5 duration-300 text-base justify-between hover:bg-amber-700 hover:text-white hover:shadow-lg cursor-pointer font-light flex flex-nowrap items-center ' +
          (selected
